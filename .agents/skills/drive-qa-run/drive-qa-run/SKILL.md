...
3. Run **Steps** verbatim from the script, _not_ from memory. Copy-paste from the doc.
...
- [ ] Each finding captured _immediately_ with artefacts (command, full output, HEAD sha, status, mutated files).
