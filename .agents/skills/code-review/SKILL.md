---
name: code-review
description: Use when the operator requests a code review, diff analysis, PR review, or wants feedback on their changes before submitting.
metadata:
  author: Prisma
  version: "2026.2.3"
---
...
1. **Identify target branch**: Use `git remote show origin | grep 'HEAD branch'` to find the default branch, or use the operator-specified target
