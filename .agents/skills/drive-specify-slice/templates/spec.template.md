...
_Why these changes hang together as one reviewable PR rather than splitting across two. Often one sentence — "this slice migrates all call sites of `X` to the new API." This is the slice-INVEST _Small_ check expressed in prose: one reviewer holds the coherence in one sitting._
