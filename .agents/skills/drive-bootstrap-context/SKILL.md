...
- __Modify the drive-_ skill files themselves._* The skill bodies already contain a "read `drive/<category>/README.md`" step; this skill only writes the file that step expects to find.
